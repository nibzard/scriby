...
```bash
curl -L -o /tmp/scriby.tar.gz "https://github.com/nibzard/scriby/releases/download/v2.1.5/scriby-v2.1.5-darwin-arm64.tar.gz"
tar -xzf /tmp/scriby.tar.gz -C /tmp
sudo install /tmp/scriby /usr/local/bin/scriby
scriby --help
```
...
```bash
make runtime-assets VERSION=v2.1.5
```
...
`https://github.com/nibzard/scriby/releases/download/v2.1.5/runtime-manifest.json`
